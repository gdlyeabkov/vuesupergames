...
app.get('/games/likes', (req, res)=>{
    ...
    let query = GameModel.findOne({'id': req.query.gameid }, function(err, game){
...
app.post('/games/uploads', upload.single('myFile'), (req, res)=>{
    ...
    res.redirect(`http://localhost:8080/?auth=true&touser=${req.query.touser}&searchText=none&gamename=${req.query.gamename}&gamedescription=${req.query.gamedescription}&gamegenre=${req.query.gamegenre}&gamesender=${req.query.gamesender}&gamecost=${req.query.gamecost}&gameimageurl=${req.query.gameimageurl}&gamefree=${req.query.gamefree}&creategame=true`)
...
*/
    ...
    app.get('/players/create', (req, res)=>{
        ...
        encodedPasswordForPlayer = bcrypt.hashSync(req.query.playername, saltRounds)
